export function LeaderboardSection() {
  const traders = [
    ...
    { rank: 2, name: "Marcus Weber", flag: "🇩🇪", country: "Germany", profit: 41780 },
    { rank: 3, name: "Yuki Tanaka", flag: "🇯🇵", country: "Japan", profit: 38920 },
    { rank: 4, name: "Elena Rossi", flag: "🇮🇹", country: "Italy", profit: 35410 },
    { rank: 5, name: "James Mitchell", flag: "🇬🇧", country: "United Kingdom", profit: 31850 },
    { rank: 6, name: "Sofia Martinez", flag: "🇪🇸", country: "Spain", profit: 28340 },
    { rank: 7, name: "David Kim", flag: "🇰🇷", country: "South Korea", profit: 25680 },
    { rank: 8, name: "Anna Kowalski", flag: "🇵🇱", country: "Poland", profit: 22150 },
    { rank: 9, name: "Lucas Silva", flag: "🇧🇷", country: "Brazil", profit: 19820 },
    { rank: 10, name: "Nina Petrova", flag: "🇷🇺", country: "Russia", profit: 17450 },
    { rank: 11, name: "Robert Thompson", flag: "🇦🇺", country: "Australia", profit: 12340 },
    { rank: 12, name: "Marie Dupont", flag: "🇫🇷", country: "France", profit: 8920 },
    { rank: 13, name: "Ahmed Hassan", flag: "🇦🇪", country: "UAE", profit: 4560 },
    { rank: 14, name: "Chen Wei", flag: "🇨🇳", country: "China", profit: -1250 },
    { rank: 15, name: "Michael Brown", flag: "🇨🇦", country: "Canada", profit: -2350 },
    { rank: 16, name: "Lisa Anderson", flag: "🇸🇪", country: "Sweden", profit: -4820 },
    { rank: 17, name: "Carlos Mendez", flag: "🇲🇽", country: "Mexico", profit: -7150 },
    { rank: 18, name: "Tom Williams", flag: "🇺🇸", country: "USA", profit: -9480 },
  ]
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-zinc-800/50">
                ...
                <th className="pb-4 text-center text-[10px] uppercase tracking-[0.2em] text-zinc-600 font-normal hidden md:table-cell">Country</th>
            ...
            <tbody>
              {traders.map((trader, index) => (
                ...
                >
                  ...
                  <td className="py-4 md:py-5 text-center hidden md:table-cell">
